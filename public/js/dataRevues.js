...
var dataRevue = [
...

	{
		name : "Design Studies " ,
		publisher: "Elsevier",
		keywords :["Architecture", "Design", "Philosophy", "Ethics", "Cognitive Science", "Computer Science", "Engineering and Construction"],
		time: [1979, 2019],
		locationCoords: [2.3514616,48.8566969],
		city: "Paris",
		country: "France",
...

	{
		...
		time: [1969, 1981],
		keywords :[ "Fine Arts & Design", "Economics", "Political Science", "Sociology", "History",	"Business, Admin & Management",	"Law", "Philosophy", "Aesthetics"],
